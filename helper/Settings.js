const HelperSettings = {
  ...
  availableSettings: {
    ...
    wasd: {
      ...
      notifyOnMention: {
        title: `PUSH уведомление при упоминании ${Helper.tooltip(
          "",
          "если окно не видно"
        )} <wasd-button class="flat-btn ovg" style="display: inline-block;padding: 5px 0 5px 10px;"><button id="testNotify" class="basic fade ovg small" type="button"> Показать тестовое уведомление </button></wasd-button>`,
        type: "boolean",
      },
      clickMentionAll: {
      ...
      limitHistoryUsers: {
        title: `Лимит истории пользователей ${Helper.F5} ${Helper.tooltip(
          "",
          "для определения цвета пользователя и его карточки, по умолчанию \u0022без ограничения\u0022 но если у вас лагает рекомендуем снизить"
        )}`,
        updateChat: true,
        type: "select",
        items: [
    ...
    highlightRole: {
      user: {
        ...
        type: "color",
        swatches: ["#00d0ff26", "#6600ff26", "#00ff1a26", "#deed0926"],
      },
      partner: {
  ...
  showMessage(message, type = "success") {
    ...
    if (message == "Расширение было обновлено | Перезагрузите страницу")
      ...
      <ol class="flexibleButtonGroup optionTypeBoolean">
        <div class="def">
          <wasd-input _ngcontent-gmb-c228="" _ngcontent-gmb-c28="" class="ng-dirty ng-touched ng-valid">
            <div ovg="" class="wasd-input-wrapper" style="padding: 0 0 4px 0;">
              <div ovg="" class="wasd-input">
                <select option-type="select" class="optionField" data-name="${name}"${
        updateChat ? " updatechat=''" : ""
      } style="padding-right: 35px;">${selectOptions}</select> <div class="accordion-header-arrow-ovg"><i class="wasd-icons-dropdown-top"></i></div>
                <ovg-tooltip><div class="tooltip tooltip_position-topRight tooltip_size-small" style="width: 260px;"><div class="tooltip-content tooltip-content_left"> Правая кнопка мыши для сброса </div></div></ovg-tooltip>
              </div>
            </div>
          </wasd-input>
          ...
          <wasd-input _ngcontent-gmb-c228="" _ngcontent-gmb-c28="" class="ng-dirty ng-touched ng-valid">
            <div ovg="" class="wasd-input-wrapper" style="padding: 0 0 4px 0;">
              <div ovg="" class="wasd-input clr-field" style="color: ${defaultValue};">
                <input ovg="" option-type="color" type="text" class="ng-pristine optionField ng-untouched ng-valid" data-name="${name}" value="${defaultValue}" data-coloris${
        updateChat ? " updatechat=''" : ""
      }/>
