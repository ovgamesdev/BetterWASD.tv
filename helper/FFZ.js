const HelperFFZ = {
    ...
    replaceText(text) {
        ...
        for (let word of split) {
            ...
            if (this.emotes[word]) word = `<img class="stickerovg small" style="vertical-align: middle; width: auto!important;" src="https://cdn.frankerfacez.com/emote/${this.emotes[word]}/${size}" alt="${word}" title="${word}" /> <span class="chat-message-text stickertext stickerovg_text">Стикер</span>`;
