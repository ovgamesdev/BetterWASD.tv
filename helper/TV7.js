const HelperTV7 = {
    ...
    replaceText(text) {
        ...
        for (let word of split) {
            ...
            if (this.emotes[word]) word = `<img class="stickerovg tv7 small" style="vertical-align: middle; width: auto!important;" src="https://cdn.7tv.app/emote/${this.emotes[word]}/${size}x" alt="${word}" title="${word}" /> <span class="chat-message-text stickertext stickerovg_text">Стикер</span>`;
